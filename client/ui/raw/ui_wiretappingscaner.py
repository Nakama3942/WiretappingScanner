...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 301, 558))
...
"font-size: 18px;")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frameshotButt.sizePolicy().hasHeightForWidth())
        self.frameshotButt.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.programshotButt.sizePolicy().hasHeightForWidth())
        self.programshotButt.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logshotButt.sizePolicy().hasHeightForWidth())
        self.logshotButt.setSizePolicy(sizePolicy)
