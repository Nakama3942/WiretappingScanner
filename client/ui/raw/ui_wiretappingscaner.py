...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.serialTool = QtWidgets.QToolButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.serialTool.sizePolicy().hasHeightForWidth())
        self.serialTool.setSizePolicy(sizePolicy)
        self.serialTool.setMinimumSize(QtCore.QSize(165, 30))
        self.serialTool.setMaximumSize(QtCore.QSize(165, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.horizontalLayout.addWidget(self.serialTool)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.uploadTool = QtWidgets.QToolButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uploadTool.sizePolicy().hasHeightForWidth())
        self.uploadTool.setSizePolicy(sizePolicy)
        self.uploadTool.setMinimumSize(QtCore.QSize(165, 30))
        self.uploadTool.setMaximumSize(QtCore.QSize(165, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.horizontalLayout.addWidget(self.uploadTool)
