...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -119, 301, 491))
        ...
        self.buttConnect = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
...
"font-size: 20px;")
        ...
        self.buttDisconnect = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setItalic(False)
...
"font-size: 20px;")
        ...
        self.verticalLayout_7.addLayout(self.verticalLayout1)
...
"font-size: 18px;")
        ...
        self.verticalLayout_7.addWidget(self.statusLine)
        ...
        self.verticalLayout_7.addLayout(self.horizontalLayout3)
        ...
        self.verticalLayout_7.addLayout(self.verticalLayout2)
        ...
        self.verticalLayout_7.addWidget(self.line4)
        ...
        self.verticalLayout3.addItem(spacerItem3)
        ...
        self.horizontalLayout4.addWidget(self.label4)
        ...
        self.horizontalLayout4.addWidget(self.dialBrightness)
        ...
        self.verticalLayout4.addItem(spacerItem4)
        self.horizontalLayout_3.addLayout(self.verticalLayout4)
        self.verticalLayout_7.addWidget(self.groupSettings)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, WindowWiretappingScaner):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabIR), _translate("WindowWiretappingScaner", "InfraRed"))
