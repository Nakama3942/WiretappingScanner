...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 301, 521))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, WindowWiretappingScaner):
        ...
        self.tabIR.setToolTip(_translate("WindowWiretappingScaner", "IR tab"))
        ...
        self.reloadTool.setToolTip(_translate("WindowWiretappingScaner", "Update IP list"))
