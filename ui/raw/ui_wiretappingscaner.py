...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.connectionGroupBox.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.connectionGroupBox.setFont(font)
        self.connectionGroupBox.setObjectName("connectionGroupBox")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.connectionGroupBox)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.IPBox = QtWidgets.QComboBox(self.connectionGroupBox)
        self.IPBox.setObjectName("IPBox")
        self.verticalLayout_8.addWidget(self.IPBox)
        self.line1 = QtWidgets.QFrame(self.connectionGroupBox)
        self.line1.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line1.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line1.setObjectName("line1")
        self.verticalLayout_8.addWidget(self.line1)
        self.verticalLayout1 = QtWidgets.QVBoxLayout()
        self.verticalLayout1.setObjectName("verticalLayout1")
        self.buttConnect = QtWidgets.QPushButton(self.connectionGroupBox)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
...
"font-size: 20px;")
        ...
        self.buttDisconnect = QtWidgets.QPushButton(self.connectionGroupBox)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setItalic(False)
...
"font-size: 20px;")
        ...
        self.verticalLayout_8.addLayout(self.verticalLayout1)
        self.line2 = QtWidgets.QFrame(self.connectionGroupBox)
        self.line2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line2.setObjectName("line2")
        self.verticalLayout_8.addWidget(self.line2)
        self.statusLine = QtWidgets.QLineEdit(self.connectionGroupBox)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(False)
        font.setItalic(True)
...
"font-size: 18px;")
        ...
        self.verticalLayout_8.addWidget(self.statusLine)
        self.line3 = QtWidgets.QFrame(self.connectionGroupBox)
        ...
        self.label1 = QtWidgets.QLabel(self.connectionGroupBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelIPaddr = QtWidgets.QLabel(self.connectionGroupBox)
        self.labelIPaddr.setObjectName("labelIPaddr")
        self.horizontalLayout1.addWidget(self.labelIPaddr)
        self.verticalLayout_8.addLayout(self.horizontalLayout1)
        self.horizontalLayout2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout2.setObjectName("horizontalLayout2")
        self.label2 = QtWidgets.QLabel(self.connectionGroupBox)
        self.label2.setObjectName("label2")
        self.horizontalLayout2.addWidget(self.label2)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout2.addItem(spacerItem1)
        self.labelPort = QtWidgets.QLabel(self.connectionGroupBox)
        self.labelPort.setObjectName("labelPort")
        self.horizontalLayout2.addWidget(self.labelPort)
        self.verticalLayout_8.addLayout(self.horizontalLayout2)
        self.line5 = QtWidgets.QFrame(self.connectionGroupBox)
        ...
        self.verticalLayout_8.addWidget(self.line5)
        self.horizontalLayout3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout3.setObjectName("horizontalLayout3")
        self.label3 = QtWidgets.QLabel(self.connectionGroupBox)
        self.label3.setObjectName("label3")
        self.horizontalLayout3.addWidget(self.label3)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout3.addItem(spacerItem2)
        self.labelSerialNum = QtWidgets.QLabel(self.connectionGroupBox)
        self.labelSerialNum.setObjectName("labelSerialNum")
        self.horizontalLayout3.addWidget(self.labelSerialNum)
        self.verticalLayout_8.addLayout(self.horizontalLayout3)
        self.line4 = QtWidgets.QFrame(self.connectionGroupBox)
        ...
        self.verticalLayout_8.addWidget(self.line4)
        self.widgetSettings = QtWidgets.QWidget(self.connectionGroupBox)
        self.widgetSettings.setEnabled(False)
        self.widgetSettings.setMinimumSize(QtCore.QSize(250, 100))
        self.widgetSettings.setObjectName("widgetSettings")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.widgetSettings)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.verticalLayout2 = QtWidgets.QVBoxLayout()
        self.verticalLayout2.setObjectName("verticalLayout2")
        self.checkPlaySound = QtWidgets.QCheckBox(self.widgetSettings)
        self.checkPlaySound.setObjectName("checkPlaySound")
        self.verticalLayout2.addWidget(self.checkPlaySound)
        self.checkRemoteMode = QtWidgets.QCheckBox(self.widgetSettings)
        self.checkRemoteMode.setObjectName("checkRemoteMode")
        self.verticalLayout2.addWidget(self.checkRemoteMode)
        ...
        self.buttWidgetScreenshot = QtWidgets.QPushButton(self.widgetSettings)
        ...
        self.verticalLayout3.addWidget(self.buttWidgetScreenshot)
        self.buttProgramScreenshot = QtWidgets.QPushButton(self.widgetSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout3.addWidget(self.buttProgramScreenshot)
        self.buttSaveLog = QtWidgets.QPushButton(self.widgetSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout3.addWidget(self.buttSaveLog)
        spacerItem4 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout3.addItem(spacerItem4)
        self.horizontalLayout_5.addLayout(self.verticalLayout3)
        self.verticalLayout4 = QtWidgets.QVBoxLayout()
        self.verticalLayout4.setObjectName("verticalLayout4")
        self.label4 = QtWidgets.QLabel(self.widgetSettings)
        self.label4.setObjectName("label4")
        self.verticalLayout4.addWidget(self.label4)
        self.dialBrightness = QtWidgets.QDial(self.widgetSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dialBrightness.setMinimumSize(QtCore.QSize(70, 70))
        self.dialBrightness.setMaximumSize(QtCore.QSize(70, 70))
        ...
        self.verticalLayout4.addWidget(self.dialBrightness)
        spacerItem5 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout4.addItem(spacerItem5)
        self.horizontalLayout_5.addLayout(self.verticalLayout4)
        self.verticalLayout_8.addWidget(self.widgetSettings)
        spacerItem6 = QtWidgets.QSpacerItem(20, 322, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
