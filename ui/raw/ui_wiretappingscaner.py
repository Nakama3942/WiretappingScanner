...
class Ui_WindowWiretappingScaner(object):
    def setupUi(self, WindowWiretappingScaner):
        ...
        self.tabWidget.setMinimumSize(QtCore.QSize(500, 560))
        font = QtGui.QFont()
        ...
        self.connectionGroupBox.setMinimumSize(QtCore.QSize(280, 560))
        ...
        self.verticalLayout_9.addWidget(self.IPBox)
        ...
        self.verticalLayout_9.addWidget(self.line1)
...
"font-size: 20px;")
        ...
        self.verticalLayout_9.addWidget(self.line2)
...
"font-size: 18px;")
        ...
        self.verticalLayout_9.addWidget(self.statusLine)
        ...
        self.verticalLayout_9.addWidget(self.line3)
        ...
        self.verticalLayout_9.addWidget(self.line5)
        ...
        self.horizontalLayout_4.addWidget(self.labelSerialNum)
        ...
        self.verticalLayout_9.addWidget(self.line4)
        self.widgetSettings = QtWidgets.QWidget(self.connectionGroupBox)
        self.widgetSettings.setEnabled(False)
        self.widgetSettings.setMinimumSize(QtCore.QSize(250, 170))
        self.widgetSettings.setObjectName("widgetSettings")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.widgetSettings)
        ...
        self.horizontalLayout_6.addWidget(self.connectionGroupBox)
